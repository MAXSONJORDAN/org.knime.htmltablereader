 ...
 */
public class HtmlTableReaderNodePlugin extends Plugin {
    // The shared instance.
    private static HtmlTableReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public HtmlTableReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static HtmlTableReaderNodePlugin getDefault() {
        return plugin;
    }
